...
<body>
    <div class="container-lg">
        <h1 style="text-align: center;">Webboard Paramee</h1>
        <?php include "nav.php"?>
        <div class="row mt-4">
            ...
            <?php   
                ...
                $sql="SELECT comment.content,comment.post_date,user.login FROM comment inner join user on (comment.user_id=user.id) where comment.post_id=$_GET[id]";
                $result=$conn->query($sql);
                $i = 1;
                while($row=$result->fetch()){ 
